...
global dadosSelecionados;
    ...
    txtSelect=strcat(caminhoDosArquivosDeTexto,aux);
                    ...
                    fclose(fid);
%            Define opçoes da lista 2 para analise grafica da tabela 2 
             set(handles.listbox2,'String',{'Porta Amostra Vazio',...
                                            'Porta Amostra só Plastico',...
                                            'Porta Amostra H20 1Min',....
                                            'Porta Amostra H20 2Min', ...
                                            'Coreção H20 1Min > (H20-Vazio-PLS)', ...
                                            'Coreção H20 2Min > (H20-Vazio-PLS)'});

                                        
     
%            Define variaveis presentes na tabela 1 (Tabela de correçoes ou tabela superior)
...
%   Opçoes para mostras nos graficos e na tabela 1 quando selecionada
                                       
    opc1 ='Porta Amostra Vazio';
    opc2 ='Porta Amostra só Plastico';
    opc3 ='Porta Amostra H20 1Min';
    opc4 ='Porta Amostra H20 2Min';
    opc5 ='Coreção H20 1Min > (H20-Vazio-PLS)';
    opc6 ='Coreção H20 2Min > (H20-Vazio-PLS)';
    
%   lê a opção para plotar grafico em nova janela:
    mostarJanela= get(handles.PlotarEmNovaJanela,'Value');
%   se 0 significa que não esta selecionada se > 0 ou "1" significa que
...
%                                         plot(Q,PA_01_H2O_PLS_1MIN,'r');
                                        title('Correção H20 = H20 - PA01 VAzio - PA01 PLS');
                                        xlabel('q(\theta,\lambda)');
                                        ylabel('Intensidade');
%                                         legend('PA01 H20-Vz-Pl','k')                                       
%                                         legend('PA01 Vazio','b')
%                                         legend('PA01 Plástico','m')
...
%                                         legend('PA01 h20 1min','r')
                                        grid on
                                            ...
                                            figure
                                                ...
                                                hold all
                                                plot(Q,PA_01_H2O_PLS_1MIN,'r');
                                                title('Correção H20 = H20 - PA01VAzio - PA01PLS');
                                                xlabel('q(\theta,\lambda)');
                                                ylabel('Intensidade');
                                                legend('PA02 H20-Vz-Pl','k')                                       
                                                legend('PA02 Vazio','b')
...
%Configura botões para calcular coreeção dos resultados da amostras somente
%em relação ao pA só com agua ERRO groceiro... mas serve para analise
set(handles.soh_agua2,'Value',0)
